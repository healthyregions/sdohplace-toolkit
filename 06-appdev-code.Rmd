...
A repository is any collection of code or data that is stored together as a unit. For example, the entire code base for [Moodle](https://github.com/moodle/moodle), or [covid-19-data](https://github.com/nytimes/covid-19-data) downloads from the NY Times.
...
![](images/06-github-clone.png){width=60%}
