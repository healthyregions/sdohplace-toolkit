...
Next, go back to Github Desktop. Add a short comment (ex. "push initial map"), Commit to Main, and then Push to Origin.
...
When you're ready, work through additional [Github Tutorials]() to get more familiar with the "push and pull" process of working with code this way.
