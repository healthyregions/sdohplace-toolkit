...
![](images/preface-street.png){style="margin-bottom:2rem;margin-top:6rem;"}

```{r, results='asis', echo=F, eval=T}
# adapted from: https://stackoverflow.com/a/70260471/3873885
block_toc <- function(title, level, output) {
  if(output == "html") {
    title <- paste(paste(rep("#", level), collapse = ""), title, "{-}")
    cat('<div style="display:none;">', title,'</div>', sep = "\n")
  }
}

block_toc(
    title = "[← Project Website](https://sdohplace.org)",
    level = 1,
