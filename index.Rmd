...
:::intro
[Module 1](https://toolkit.sdohplace.org/01-intro.html)</br>
[**Introduction**](https://toolkit.sdohplace.org/01-intro.html)</br>
Explores SDOH, equity, and types of visualizations. *Led by Kamaria Barronville, José Alavez, & Marynia Kolak*.
:::

:::planning
[Module 2](https://toolkit.sdohplace.org/02-scoping.html)</br>
[**Project Planning**](https://toolkit.sdohplace.org/02-scoping.html)</br>
...
:::hcd
[Module 3](https://toolkit.sdohplace.org/03-design.html)</br>
[**Human Centered Design**](https://toolkit.sdohplace.org/03-design.html)</br>
...
:::wrangling
[Module 4](https://toolkit.sdohplace.org/04-data.html)</br>
[**Spatial Data Wrangling**](https://toolkit.sdohplace.org/04-data.html)</br>
...
:::research
[Module 5](https://toolkit.sdohplace.org/05-analysis.html)</br>
[**Research Design & Analysis**](https://toolkit.sdohplace.org/05-analysis.html)</br>
...
:::dev
[Module 6](https://toolkit.sdohplace.org/06-appdev.html)</br>
[**App Development**](https://toolkit.sdohplace.org/06-appdev.html)</br>
...
:::share
[Module 7](https://toolkit.sdohplace.org/07-dissem.html)</br>
[**Sharing Your Prototype**](https://toolkit.sdohplace.org/07-dissem.html)</br>
