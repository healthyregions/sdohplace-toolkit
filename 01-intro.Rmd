...
#### Tools for this module (Your toolkit journal): {-}
...
#### Let's consider these common goals as your potential roadmaps: {-}
...
Map health outcomes and demographics to identify disparities.
Targeting Interventions
Use spatial analysis to direct resources effectively.
Assessing Access to Healthcare
Map service accessibility to pinpoint healthcare gaps.
Modeling SDOH at Different Scales
Analyze SDOH impact across scales for insight into health influences.
Environmental Health
Create dashboards to monitor environmental health risks.
Health Planning and Policy Interventions
Inform policy with visualizations to address health challenges.
Community Engagement
Use story maps to involve communities in decision-making.
Monitoring and Evaluation
Track interventions over time with spatio-temporal dashboards.
...
Data and Stats | Tulsa Health Department
United States of Health Dashboard | Public Sector | McKinsey & Company
Heart Disease Death Rates Aged 35 and older, Total Population | cdc.gov




1.2 Stakeholders
Once you've got your project's goals on the horizon, it's time to look at who's journeying with you. Collaboration and stakeholder identification are vital components of any project that aims to achieve equity. Whether it's a non-governmental organization, a research group within a university, or a government agency, stakeholders bring diverse perspectives and expertise to the table. Similarly, communities, activists, and advocates can also play a significant role in your project's success. Early identification of stakeholders is key to building trust and solidarity, which is a time-consuming but necessary process. By working together with your stakeholders, you can produce an impactful SDOH project. 
...
Urban Youths Go 3000 Miles: Engaging and Supporting Young Residents to Conduct Neighborhood Asset Mapping | AJPH
...
US Social Determinants of Health Atlas - Map of the Month




1.4 Data visualizations that consider spatial data 
...
United States of Health (Source: https://www.mckinsey.com/industries/public-sector/our-insights/us-public-health-dashboard) 
...
The Mapping of Race in America (Source: https://storymaps.arcgis.com/stories/ac998a8425b54e319f61d34ff1a94a0c) 
...
US Covid Atlas (Source: https://uscovidatlas.org/map) 
