...
* Explore social determinants of health, equity, and data visualizations
* Begin to consider what type of visualization you want to use
...
![Social Determinants of Health](images/preface-SDOH1.png){width=80%} 

The social determinants of health are complex and exist at many different scales — the individual, interpersonal, community, and regional levels. In this toolkit, we focus on how the SDOH emerge at community and regional levels. For example, neighborhoods will have differing availability of fresh produce, community clinics, and job opportunities, impacting how residents are able to successfully eat healthy, visit health providers, and be able to afford housing essentials When working with measures at neighborhood-levels, a spatial view is essential to enable us to work with the data, from data wrangling to visualization and analysis. A [neighborhood-view of SDOH](https://jamanetwork.com/journals/jamanetworkopen/fullarticle/2759757) is multidimensional, and can predict over 60% of premature deaths. 
...
## Dynamic (Spatial) Data Visualizations 
...
![In this dashboard, clicking on a location launches an interactive infographic of detailed health outcomes. Source: [Appsilon](https://connect.appsilon.com/air-quality/)](images/preface-airquality.png)
...
![The Stavros Niarchos Foundation from Greece produced a storymap to present their current health initiatives](images/preface-storymap.png) *The Stavros Niarchos Foundation from Greece produced a storymap to present their current health initiatives* (source: https://uploads.knightlab.com/storymapjs/ddf1b1212ec9c9aac4bebe45196b367d/hi-update-english/index.html)
...
- **Explore App Marketplaces**
Check popular app marketplaces such as the Apple App Store, Google Play Store, and web-based platforms for healthcare applications. Look for user reviews, ratings, and feedback to gauge the effectiveness and user satisfaction of existing tools.
...
![Centering Equity](images/preface-centeringequity1.png)
...
In the realm of social determinants of health (SDOH) data visualization, adopting a [trauma-informed mindset](https://ncsacw.acf.hhs.gov/userfiles/files/SAMHSA_Trauma.pdf) is crucial for creating solutions that are sensitive, empathetic, and inclusive. Trauma-informed decision-making ensures that your project respects the experiences and well-being of individuals whose data is being visualized. Here are key considerations to guide your decision-making process with a trauma-informed approach:
...
![Spatial Data Visualization Options](images/preface-map.png)
...
![Climate Risk by County (Source: American Communities Project](images/preface-thematic.png){width=100%}  
...
![The Mapping of Race in America ([Hessler et al 2023](https://storymaps.arcgis.com/stories/ac998a8425b54e319f61d34ff1a94a0c))](images/preface-storymap.png){width=90%}  
