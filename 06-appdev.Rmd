...
- [Example 1: Word on the Street](https://arcg.is/1bPHeK0)

- [Example 2: Segregation is Killing us...](https://arcg.is/0KTDX4)

- [Example 3: Mapping the Spread of COVID-19](https://arcg.is/0HDezC)

*KnightLab* 

- [Example 1: Southern Literary Trail](https://www.georgiahumanities.org/southern-literary-trail-story-map/)

- [Example 2: Black Hawk in the Midwest, 1767-1812](https://publications.newberry.org/time-machine/blackHawk/)

- [Example 3: Corona Diaries of the Urban Poor](https://www.justempower.org/coronadiaries) *best example but stamen basemap :(*
