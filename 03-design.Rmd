...
![Figure 3.1.2](images/hcd-1.2.png){width=90%} 

3. Once you have your new team, Click on this [link](https://www.figma.com/community/file/1027357893837345723/user-persona) to access the User Persona FigJam template webpage and click on the "open in Figjam" button.  This action will lead you to your new user persona template.
...
![Figure 3.2.1](images/hcd-2.1.png){width=90%} 
...
![Figure 3.2.2](images/hcd-2.2.png){width=90%} 
...
![Figure 3.2.3](images/hcd-2.3.png){width=90%} 
...
![Figure 3.2.5](images/hcd-2.5.png){width=90%} 
...
![Figure 3.3.2](images/hcd-3.2.png){width=90%} 

Step 4: Save and Export

1. If you need to share the user personas outside of FigJam, you can export the file by clicking on the “Main Menu" icon, selecting "File" and "Export as" to choose your desired format (PDF, JPG. PNG etc).
