...
*Download the Activity Datasets and Set Up Your Environment [See Module 4](https://toolkit.sdohplace.org/04-data.html)*
...
- **Data Limitations:** How was the data you have collected? Are there any biases or issues you need to consider when interpreting findings? What's missing?  
...
Scatter plots are invaluable for visualizing relationships and uncovering possible correlations (both positive and negative) or patterns between socioeconomic factors and health indicators.
...
- Equal intervals are easy to read and understand; but it can be misleading in that no information is given on the distribution of the data within each distinct class. Thus, this method may not be ideal for skewed distributions or when outliers are present.
