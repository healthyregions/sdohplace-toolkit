...
The field of project management is vast, interdisciplinary, and always growing. Here are some highlights that can go a long way in scoping your project effectively. 
...
**System Requirements** Based on the inventory of your project assessment above, you're ready to generate a list of system requirements. Identify major system capabilities (e.g. must be available on Internet),  system assumptions or constraints (e.g. must visualize spatial data as a thematic map; must use free or opensource technologies), user characteristics, and any other requirements. You may find multiple templates online for ideas.
