...
Spatial data is generally divided into two broad categories: vector data and raster data. Vector data holds "features" using points, lines, or polygons whereas raster data can be satellite imagery or other pixelated surfaces.
