...
For this exercise, download `chicago_methadone_nogeometry.csv`, a dataset of methadone centers in Chicago that only includes center names and addresses.
...
:::activity
We’ll create a spatial join with affordable housing development data and ChiZipCleaned.geojson. In this case, we’ll add the number of affordable housing developments in each zip code to the zip code dataset.
